...
<body>
    ...
    <header>
        <div id="logo">
            <img src="img/logito.png" alt="CompartiendoCodigo" id="imagen">
        </div>
        <div id="datos">
            <p id="encabezado">
                <b>Ferreteria y Matizados Tonny's</b><br>Trujillo, Perú<br>Telefono:(+51)940182218<br>Email:
                aguilar_verde@hotmail.com
            </p>
        </div>
        <div id="fact">
